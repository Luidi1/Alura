...
/*let respostaLinguagemProgramacaoFavorita = prompt('Digite o nome da sua linguagem de programação favorita: ');
console.log(`Sua linguagem de programação favorita é ${respostaLinguagemProgramacaoFavorita}`);*/ 
