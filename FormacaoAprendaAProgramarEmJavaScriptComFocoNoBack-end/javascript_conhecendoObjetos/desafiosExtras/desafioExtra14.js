...
//     this.ligado ? console.log('Carro já está ligado') : console.log('Carro está ligado.');
// }

// carro.desligar = function(){
//     this.ligado ? console.log('Carro desligado.') : console.log('Carro já está desligado');
// }

// carro.obterDetalhes = function(){
//     return `Marca: ${this.marca}, modelo: ${this.modelo}, ano: ${this.ano}, ligado?: ${this.ligado}`;
// }
